<div class="product__images shadow border border-light-sm">
    <div class="row">
        <div class="col-12">
                ...
                <div class="sp-slides">
                    <div class="sp-slide">
                        <img class="sp-image" src="{{ $product->getFirstMediaUrl('main_image', 'thumb') }}"
                             data-src="{{ $product->getFirstMediaUrl('main_image', 'medium') }}"
                             data-small="{{ $product->getFirstMediaUrl('main_image', 'thumb') }}"
                             data-medium="{{ $product->getFirstMediaUrl('main_image', 'medium') }}"
                    ...
                    @foreach ($product->getMedia('additional_images') as $image)
                        <div class="sp-slide">
                            <img class="sp-image" src="{{ $image->getUrl('thumb') }}"
                                 ...
                                 data-medium="{{ $image->getUrl('medium') }}"
