<ul class="sidebar-menu scrollable pos-r ps">
    ...
    <li class="nav-item">
        <a href="{{ route('securedPagesListPage') }}" class="sidebar-link"><span class="icon-holder"><i class="c-blue-500 ti-files"></i></span><span class="title">Pages</span></a>
    </li>
    <li class="nav-item dropdown">
        <a href="#" class="dropdown-toggle">
        ...
        <ul class="dropdown-menu">
            <li><a class="sidebar-link" href="{{ route('securedAddNewNewsItem') }}">Add</a></li>
            <li><a class="sidebar-link" href="{{ route('securedNewsListPage') }}">List</a></li>
        </ul>
    </li>
    <li class="nav-item dropdown">
        <a href="#" class="dropdown-toggle">
